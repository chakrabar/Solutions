namespace Wikipedia.IntegrationTests
{
    public class TestConstants
    {
        ...
        public static readonly string[] CorrectAnswers = new[]
            {
        ...
        public static readonly string[] SampleInput = new[]
            {
                Wiki,
                Questions[0],
                Questions[1],
