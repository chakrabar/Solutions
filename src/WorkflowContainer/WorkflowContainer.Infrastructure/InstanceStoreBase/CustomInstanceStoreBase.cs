...
namespace WorkflowContainer.Infrastructure.InstanceStoreBase
{
    public abstract class CustomInstanceStoreBase : InstanceStore, IDisposable
    {
        ...
        public abstract void Save(Guid instanceId, XmlDocument doc); //Guid storeId, 
        ...
        protected override IAsyncResult BeginTryCommand(InstancePersistenceContext context, InstancePersistenceCommand command, TimeSpan timeout, AsyncCallback callback, object state)
        {
            ...
            if (command is CreateWorkflowOwnerCommand || command is CreateWorkflowOwnerWithIdentityCommand) //ac
            {
            ...
            else if (command is SaveWorkflowCommand)
            {
                ...
                Save(context.InstanceView.InstanceId, instanceStateXml);
            }
            //The LoadWorkflow command instructs the instance store to lock and load the instance bound to the identifier in the instance handle
            else if (command is LoadWorkflowCommand)
            {
                var xml = Load(context.InstanceView.InstanceId);
